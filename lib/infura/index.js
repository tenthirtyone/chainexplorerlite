...
class Infura {
  ...
  /**
   * This service is scheduled to run at Ethereum's TPS or faster.
   * It will establish a listener for new  blocks that are mined
  ...
  */
  ...
  addBlockToEndOfQueue(number) {
    ...
    this.tempCache.add(header.number, true);
